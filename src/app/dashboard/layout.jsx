    ...
    return (
        <div className="h-screen w-full overflow-hidden bg-white">
            <div className="flex h-full w-full">
                {/* Sidebar */}
                <aside className="hidden md:flex h-screen w-[232px] shrink-0 flex-col bg-[#0c111d] text-white border-r border-white/[0.06] selection:bg-cyan-500/30">
                    ...
                    <div className="relative px-5 py-4 shrink-0">
                        ...
                        <div className="relative flex items-center gap-2.5">
                            ...
                            <div className="leading-none">
                                <div className="text-[12px] font-semibold tracking-[-0.01em] text-white">AgendaClinica</div>
                                <div className="mt-0.5 text-[9px] font-medium text-white/40">Panel Administrador</div>
                            </div>
                        </div>
                    ...
                    <nav className="flex-1 px-2.5 py-3 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                        <div className="space-y-0.5">
                            ...
                            <details className="group" open>
                                <summary className="flex items-center justify-between rounded-md px-2.5 py-1.5 text-[10px] font-semibold tracking-wide text-white/40 hover:text-white/60 transition-colors duration-150 cursor-pointer list-none select-none">
                                    <span>Principal</span>
                        ...
                        <div className="mt-4 pt-3 relative">
                            <div className="absolute top-0 left-2.5 right-2.5 h-px bg-gradient-to-r from-transparent via-white/[0.08] to-transparent" />
                            <div className="px-2.5 text-[10px] font-semibold tracking-wide text-white/30">Atajos</div>
                            <div className="mt-1.5 space-y-px">
                                <Link
                                    href="/"
                                    className="group/link flex items-center gap-2 rounded-md px-2.5 py-[6px] text-[12px] font-medium text-white/60 hover:text-white hover:bg-white/[0.06] transition-all duration-150"
                                >
                                    <svg className="h-3 w-3 text-white/30 group-hover/link:text-cyan-400 transition-colors duration-150" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div className="relative px-3 py-3 shrink-0">
                        ...
                        <div className="rounded-lg bg-white/[0.03] ring-1 ring-white/[0.06] px-3 py-2.5">
                            <div className="flex items-center justify-between">
                                <div>
                                    <div className="text-[9px] font-medium text-white/35 tracking-wider">Estado</div>
                                    <div className="mt-0.5 text-[11px] font-semibold text-white/80">Operativo</div>
                                </div>
                                <div className="relative">
                                    <span className="absolute inset-0 rounded-full bg-emerald-400/20 animate-ping" />
                                    <span className="relative h-1.5 w-1.5 rounded-full bg-emerald-400 block shadow-[0_0_8px_rgba(52,211,153,0.4)]" />
                                </div>
                            </div>
                        </div>
                    </div>
